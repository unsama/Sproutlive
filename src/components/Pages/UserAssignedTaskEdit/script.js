...
export default{
    ...
    methods: {
        select: function () {
            ...
            self.$http.post("/assigned_task_view", {"id": self.$route.params.id}).then(function (res) {
            ...
            self.$http.post("/project", {"name": self.name}).then(function(res){self.options = res.body.result;},function(err){
                alert(err);
            });
            self.$http.post("/user_id", {"user_name": self.username}).then(function(res){self.user_id = res.body.result;},function(err){
                alert(err);
            });
            self.$http.post("/tags_id", {"usersname": self.name}).then(function(res){self.tag_id = res.body.result;},function(err){
                alert(err);
            });
            self.$http.post("/contact_id", {"contactname": self.name}).then(function(res){self.contact_id = res.body.result;},function(err){
                alert(err);
            });
        },
        ...
        update: function () {
            ...
            self.$http.post("/update_user_assigned_task", {
