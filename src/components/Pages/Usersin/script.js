...
<<<<<<< HEAD
    ...
    methods: {
        select: function () {
            ...
            self.$http.post("/user_info", {"id": self.$route.params.id}).then(function (res) {
        ...
        previous_pagination: function () {
            var self = this;
            //alert(self.companyName);
            self.$http.post("/user_pagination_next", {"id": self.$route.params.id}).then(function (res) {
                var parentdata = res.body.result[0];
        ...
        next_pagination: function () {
            var self = this;
            //alert(self.companyName);
            self.$http.post("/user_pagination_previous", {"id": self.$route.params.id}).then(function (res) {
                var parentdata = res.body.result[0];
        ...
        pwd_update: function () {
            var self = this;
            //alert(self.current_company+ " ");
            self.$http.post("/user_pwd_update", {
        ...
        user_duplicate: function () {
            var self = this;
            //alert(self.current_company+ " ");
            self.$http.post("/duplicate_users", {"id": self.$route.params.id ,"status": self.status}).then(function(res){
                console.log(res.body);
            },function(err){
                // alert(err);
            });
        ...
        count: function () {
            var self = this;
            //alert(self.current_company+ " ");
            self.$http.post("/user_count", {"id": self.$route.params.id ,"user_id": self.id}).then(function(res){
                console.log(res.body);
            },function(err){
                alert(err);
            });
        ...
        submit_inside: function () {
            var self = this;
            //alert(self.current_company+ " ");
            self.$http.post("/delete_users_inside", {"id": self.$route.params.id }).then(function(res){
                console.log(res.body);
            },function(err){
                //alert(err);
            });
