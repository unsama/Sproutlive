...
export default{
    ...
    methods: {
        select: function () {
            ...
            self.$http.post("/user_data", {"id": self.$route.params.id}).then(function (res) {
        ...
        submit: function () {
            var self = this;
            self.$http.post("/update_user_value", {"id": self.$route.params.id ,"username": self.username,"company_name": self.company_name,"current_company": self.current_company, "email": self.email,
