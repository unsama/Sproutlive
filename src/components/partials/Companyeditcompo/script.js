...
export default{
    ...
    methods: {
        project_modal: function () {
            var self = this;
            self.$http.post("/project_id", {"id": self.product_detail}).then(function(res){
        ...
        select: function () {
            ...
            self.$http.post("/company_info", {"id": self.$route.params.id}).then(function (res) {
            ...
            self.$http.post("/company_country_states", {"state_name": self.state_name}).then(function(res){self.state_name_data =res.body.result;},function(err){
               // alert(err);
            });
            self.$http.post("/company_country_name", {"country_name": self.country_name}).then(function(res){self.country_name_data =res.body.result;},function(err){
                //alert(err);
            });
            self.$http.post("/company_currency_name", {"currency": self.currency}).then(function(res){self.currency_name_data =res.body.result;},function(err){
                //alert(err);
            });
            self.$http.post("/companytable", {"company_name": self.company_name}).then(function(res){self.company_name_parent_data =res.body.result;},function(err){
                //alert(err);
            });
        ...
        update: function () {
            ...
            self.$http.post("/company_date_update", {
